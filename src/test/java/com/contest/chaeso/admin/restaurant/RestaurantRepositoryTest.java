...
public class RestaurantRepositoryTest {
    ...
    public void insertRestaurantTest(){
        ...
        Float[] corpLatList = new Float[]{37.5677070f, 37.569187f, 37.568458f, 37.565853f, 37.560726f, 37.564440f};
        Float[] corpLonList = new Float[]{126.980003f, 126.986559f, 126.982261f, 126.973614f, 126.981329f, 126.991050f};
...
//-- 37.56673, 126.982000 : 을지로입구 : 내 위치

//-- 37.5677070, 126.980003 : 500m 내
//-- 37.569187, 126.986559 : 500m 내
//-- 37.568458, 126.982261 : 500m 내
//-- 37.565853, 126.973614 : 500m 외
//-- 37.560726, 126.981329 : 500m 외
//-- 37.564440, 126.991050 : 500m 외
        ...
        for(int i = 0; i < 6; i++){
            ...
            Restaurant restaurant = Restaurant.createRestaurant(
                    rtName[i],
                    rtCategory[i],
                    new Address(rtAddress[i], corpLatList[0], corpLonList[0]),
                    phoneNumber,
                    new MealType(mealType, mealType, mealType));

            // restaurant menu
            RestaurantMenu rtMenu1 = RestaurantMenu.createRestaurantMenuWithCascade(rtName[i]+" 메뉴 테스트" + 1, 11000, "menu img test link");
            RestaurantMenu rtMenu2 = RestaurantMenu.createRestaurantMenuWithCascade(rtName[i]+" 메뉴 테스트" + 2, 12000, "menu img test link");
            RestaurantMenu rtMenu3 = RestaurantMenu.createRestaurantMenuWithCascade(rtName[i]+" 메뉴 테스트" + 3, 13000, "menu img test link");
            ...
            // restaurant img
            RestaurantImg rtImg1 = RestaurantImg.createRestaurantImgWithCascade(reImgLink + "대표이미지", 1);
            RestaurantImg rtImg2 = RestaurantImg.createRestaurantImgWithCascade(reImgLink, 0);
            RestaurantImg rtImg3 = RestaurantImg.createRestaurantImgWithCascade(reImgLink, 0);
