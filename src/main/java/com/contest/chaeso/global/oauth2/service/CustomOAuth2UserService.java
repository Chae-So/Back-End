package com.contest.chaeso.global.oauth2.service;
...
import com.contest.chaeso.global.oauth2.CustomOAuth2User;
import com.contest.chaeso.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Users getUser(OAuthAttributes attributes, SocialType socialType) {
        Users findUser = usersRepository.findBySocialTypeAndSocialId(socialType,
